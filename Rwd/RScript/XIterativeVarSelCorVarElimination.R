...
xVarSelectFileName <- "/shared/GitHub/Tesera/Rwd/XVARSELV1.csv"
...
uniqueVarPath <- "/shared/GitHub/Tesera/Rwd/UNIQUEVAR.csv"
...
xVarCountFileName <- "/shared/GitHub/Tesera/Rwd/XVARSELV1_XCOUNT.csv"
...
source("/shared/GitHub/Tesera/Rwd/RScript/ZReadXvarselvCount.R")
initialCount <- xVarCount
#
# Step 3
# Initialize Variable selection process
source("/shared/GitHub/Tesera/Rwd/RScript/ZCompleteVariableSelectionPlusRemoveCorrelationVariables.R")
source("/shared/GitHub/Tesera/Rwd/RScript/ZReadXvarselvCount.R")
#
# Step 4
repeat {
