...
# graphicsPackageName5 = maps: Adds basic maps and ability to read shapefiles to R
library(maps)
...
# Select Variable Subsets for analysis via the subselect packages
# varsubsetsPackageName = subselect
library(subselect)
