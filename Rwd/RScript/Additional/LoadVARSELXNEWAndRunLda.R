...
#load  a csv text file, named VARSELXNEW.txt to select X-variables
fileName <- "D:\\Rwd\\Rdata\\Input\\VARSELXNEW.txt"	#Set file name for variable selection input
...
#Get the list of elgible x variables and slect the variables from the datafile 
