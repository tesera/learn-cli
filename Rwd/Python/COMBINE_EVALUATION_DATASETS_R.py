...
innerJoinKeyValues = innerJoinDictDBs.getCommonInnerJoinKeyValueList(ctabDictUniqueKeyList, postDictUniqueKeyList)
#combDict = innerJoinDictDBs.extractDictDBForKeySetsList(combDict,postDict,innerJoinKeyValues)
combDict = innerJoinDictDBs.extractDictDBForKeySetsList(ctabDict,postDict,innerJoinKeyValues)
#combHeader = innerJoinDictDBs.createUniqueListFromTwoNewLists(combHeader,postHeader)
combHeader = innerJoinDictDBs.createUniqueListFromTwoNewLists(ctabHeader,postHeader)
#
