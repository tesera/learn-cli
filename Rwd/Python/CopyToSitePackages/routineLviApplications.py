...
def removeRecordsFromDictWithSpecifiedValues(myDataDict = {}, varNamesList = [], removeVarValuesList = [], keyVarNameList = []):
    '''
...
def extractNewDictVariableSubset(myDataDict={}, keyVarNamesList = [], varNameSubset = []):
    '''
    '''
    newDataDict = {}
...
def identifyUniqueValuesForAGivenListOfVariableNamesInRow0(dataList = [[]], varNameList = []):
    '''
    '''
    uniqueVarValueList = []
...
def GetSpeciesListFromPlotOrTreeData(myTypedDict = {},spColNamesList = []):
    '''
    '''
    spList = []
...
def GetSpeciesCodesFromFileOrAssigneNewSpeciesCodes(myTreeDict = {}, spColNamesList = [], spTableName = 'SPDICT', dataDictType = 'TWOKEY'):
    '''
...
def getTargetDatasetNearestNeighbousForSingleVarsetsUsingZScores_v2(maxKNN = 1, varSet = 1, targTypedList = [[]], targKeyVarNames = [], refTypedList = [], \
...
def writeListArrayToCsvFile(TwoDList = [[]], fileName = '', floatFormat = ''):
    '''
    '''
    dataMachete.writeListarrayToCSVFile(TwoDList, dataFilePath, fileName, floatFormat, fileExtension)
    return
...
def SelectTreesAboveMinimumThrehsold(treeDict={}, treeDictColName = '', minimumThreshold = 0):
    '''
    Note that the tree dictionary contains a unique ID for each plot and has a list of
    trees as secondary keys.
    '''
...
def ReplaceTreeSpeciesInOneKeyDataWithNewSpecies(dataDict={}, spDict={}, spColNamesList=[], dictKeyNo = 'ONEKEY'):
    '''
    '''
...
def CompilePlotLevelSpeciesProportions(plotDict = {},plotDictKeyVarNameList = [], speciesList = [], spColNameList = [], spPcntNameList = []):
    '''
    '''
...
def DeepCopyList(dataList = []):
    newList = deepcopy(dataList)
    return newList

def InnerJoinDictAAndDictBAndExtractVariableSubset(dataDictA = {}, dataKeyVarNames = [], dataDictB = {}, extractVarNameList = []):
    '''
...
def compileSpeciesDominance(spPcntDict = {}, spList =[]):
    '''
    '''
...
def CompilePlotQuadraticMeanTreeDiameters(plotBaphSumDict = {}, plotTphSumDict = {}):
    '''
    '''
    qmdDict = {}
...
def CompileSpeciesPlotStatisticsIntoOneDictionary(plotSpDict = {}, plotSpDictAdd={}, plotSpHeader = [], plotSpKeyVarNameList=['PLOTID'], \
...
def CombinePlotSumDictionariesIntoOne(plotSumDict = {}, plotSumHeader = [], plotSumDictAdd = {}, plotSumKeyVarNameList = ['PLOTID'], plotSumAddVarName = 'SUM', \
                                      newPlotSumVarName = ''):
    '''
    '''
...
def CompileCumulativeDistributions(xVarName = '', minXVar = 0, maxXVar = 140, yVarName = '', yVarNameNew = '', \
...
def compileAttributeRanks(dataDict = {}, rankVarName = '', rankDict = {}, rankHeader = [], rankKeyVarNameList = ['RAVARNAME','RVARVALUE']):
    '''
    '''
    if rankHeader == []:
...
def rankAdjustCumulativeDistributions(plotSumDict={}, rankDict={}, cumDistDict={}, minXVar=0, maxXVar=0, \
...
def CalculateQmdBphSphForPlotTreeDict(treeDict = {}, treeDbhName = '', treeSphName = '', minDbhThreshold = 0):
    '''
    '''
    plotList = treeDict.keys()
    newPlotDict = {}
...
def CalculateLoreysMeanTreeHeight(treeDict = {}, treeDbhName = '', treeSphName = '', treeHeightName = '', minDbhThreshold = 0):
    '''
    '''
    plotList = treeDict.keys()
    newPlotDict = {}
...
def CompileNewTreeDictToDbhThreshold(treeDict = {}, treeKeyVarNames = [], treeSpeciesName = 'SP', treeDbhName = 'DBH', \
...
def CompileLorenzStatistics(plotTreeDict = {}, dbhVarname = '', sphVarname = '', bphVarname = '', dbhInterval = 1, maxDbh=140):
    '''
    '''
...
def calculateUnivariateSTVI(plotTreeDict = {}, dbhVarname = '', sphVarname = '', bphVarname = '', maxDbh = 140):
    '''
    '''
...
def ComputeNaturalLogarithMicTranformations(plotSumDict, plotSumHeader, preTransformVarNameList, postTransformVarNameList):
    '''
    '''
...
def innerJoinTwoDictWithSameKeysDifferentVariables(parentDict = {}, parentHeader = [], childDict = {}, childHeader = [], keyVarNameList =[]):
    '''
    '''
...
def RemovePlotsBelowMinimumAndAboveMaximumCriteria(plotDict = {}, linkDict = {},  criteriaVarName = '', minCriteria = 0, maxCriteria = 10000000):
    '''
    '''
...
def SelectCumulativeDistributionsUsingLinkDict(parentDict={}, selectKeysDict={}, keyVarnameList = []):
    '''
    '''
...
def CompileAviSiteIndices(dataDict = {}, speciesCol = 'SPECIES', bhageCol = 'AGE', totalAgeCol = 'NULL', \
...
def CompileAviSiteIndices_v2(dataDict = {}, speciesCol = 'SPECIES', bhageCol = 'AGE', totalAgeCol = 'NULL', \
...
def RecoverYearMonthAndDay(measDate = '', measDateFormat = 'dd/mm/yyyy'):
    '''
    '''
    day = 0
    month = 0
...
def ProjectHeightAndAgeGivenSiteIndices(siDict ={},siDictHeader=[],  \
...
def CompileGypsySiteIndices(dataDict = {}, speciesCol = 'SPECIES', bhageCol = 'AGE', totalAgeCol = 'NULL', \
                          treeHeightCol = 'HT_MEAS', treeMeasDateCol = 'MEASDATE', measDateFormat = 'dd/mm/yyyy'):
    '''
    '''
    siDict = {}
...
def CompileGypsySiteIndices_v2(dataDict = {}, speciesCol = 'SPECIES', bhageCol = 'AGE', totalAgeCol = 'NULL', \
                          treeHeightCol = 'HT_MEAS', year = 2011):
    '''
    '''
    siDict = {}
...
def calculateStandAgeFromDateOfOrigin(dataDict = {}, dataDictHeader = [], originVarName = 'IGB_ORIGIN', invYearVarName = 'IGB_INV_YEAR', \
...
def compileAlbertaTimberProductivityRating(spSiDict = {}, spSiDictHeader = [], spVarName = 'SPECIES', siVarName = 'SI'):
    '''
    '''
...
def ExtractPhotoInterpreterSpeciesRecognition(photoInterpDict = {}, photoInterpKeyVarNames = [], photoInterpreterList = [], speciesNameList = []):
    '''
...
def CrossTabulateInterpeterSpeciesRecognition(plotInterpDict = {},piCtabKeyVarName = 'NPLOTID',photoInterpreterList = [],speciesNameList = []):
    '''
...
def combinedDictionariesWithCommonKeyStructure(dataDictA = {}, dataDictB = {}, keyVarNames = [], dataHeader = [], keyLevelMatch = 1):
    '''
...
def compileStageSlopeAspectElevTransformationsAndAddToData(dataDict={},keyVarNameList = [], slopeVarName = 'SLOPE', elevationVarName = 'ELEV', aspectVarName = 'ASP', \
