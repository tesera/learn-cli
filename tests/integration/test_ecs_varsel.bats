...
setup () {
    ...
    s3_wd_prefix="tests/varsel"
    s3_output_prefix="tests/output/varsel"
    ...
    aws s3 cp "$s3_fixture_path/$vsel_xy_config" "$s3_wd_path/$vsel_xy_config"
  ...
  "containerOverrides": [
    {
      ...
      "command": [
        ...
        "--config=$s3_wd_path/$vsel_xy_config",
...
EOF
    ...
    task=$(aws ecs run-task \
        ...
        --started-by learn-ecs/tests/varsel)
